                        ...
                        <div class="space-y-5">
                            ...
                            <div class="flex items-center">
                                ...
                                <label for="agree" class="ml-3 text-sm font-medium text-gray-500">
                                    I agree to Hawa <Link href="#" title="" class="text-orange-500 hover:text-orange-600 hover:underline">Terms of Service</Link> and <Link to="#" title="" class="text-orange-500 hover:text-orange-600 hover:underline">Privacy Policy</Link>
                                </label>
                            </div>

                            <div>
                                <button type="submit" class="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-orange-500 border border-transparent rounded-md focus:outline-none hover:bg-orange-600 focus:bg-orange-700">
                                    Create account
                                </button>
                            </div>

                            <div class="text-center">
                                <p class="text-base text-gray-600">Already have an account? <Link to="/sign-in" title="" class="font-medium text-orange-500 transition-all duration-200 hover:text-orange-600 hover:underline">Sign In here</Link></p>
                            </div>
                        </div>
                    </form>
                </div>
